...
cmmute1		call    Send_1;      // 43
		call    Send_0;      // 43
		movlw	d'32'
		call	Big_delay
		return
		
Send_1 		movlw   d'25'	    ; 527 millisekund
		movwf   Reg_1
Send1_Loop	bsf     IR_LED
		...
		return
;-----------------------------------------------------------------------------		
Send_0		movlw   d'28'	;527 millisekund
		movwf   Reg_1
