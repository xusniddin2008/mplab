...
unsigned int gabOn = 50;
unsigned int gabOff = 38;
unsigned int blijOn = 100;
unsigned int blijOff = 40;
unsigned int i;
unsigned int volt;
...
void main(void) {
    ...
    while (1) {
        while (GP3 == 1) {
            ...
            if (volt > blijOn && GP0 == 0) {
                blijniyOn();
            }
            if (volt < blijOff && GP0 == 1) {
                blijniyOff();
            }
            if (volt < gabOff && GP1 == 1) {
                gabaritOff();
            }
        }
        if (GP5 == 0) {
